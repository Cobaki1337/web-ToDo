...
public class GetRecycleTasksController extends AbstractController {
    @Override
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            List<Task> taskList = ApplicationContext.getTasksDAO().getRecycleTasks(user.getId());
            String recycleTasks = new Gson().toJson(taskList);
            writer.print(recycleTasks);
